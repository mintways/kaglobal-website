...
/**
 * KA Global IP – Patent Renewal Fees by Country: Canada
 * -----------------------------------------------------
 * Path:
 * /app/solutions/renewal-fees-by-country/canada/page.tsx
 *
 * Brand colors:
 *  - Primary: #7F2B38
 *  - Accent:  #4D1475
 ...
 *
 * Notes:
 *  - Fee numbers below are placeholders in CAD. Replace with live data.
...
const SAMPLE_FEES = Array.from({ length: 20 }, (_, i) => {
    ...
    const official = year < 3 ? 0 : 95 + year * 18;
                ...
                <div className="grid items-center gap-8 md:grid-cols-12">
                    <div className="md:col-span-7">
                        <h1 className="text-3xl md:text-5xl font-extrabold leading-tight">
                            Canada — Patent Renewal Fees (2025 Guide)
                        </h1>
                        <p className="mt-4 text-base md:text-lg text-white/90">
                            Keep your Canadian patents in good standing with transparent fees, reminders, and global
        ...
        <section className="bg-[#F0F0F0] py-8 md:py-10">
            <div className="mx-auto max-w-7xl px-6">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
                    ...
                    <FactCard label="Coverage" value="National patents (incl. EP counterparts handled separately)" icon={<FileText className="h-5 w-5" />} />
    ...
    return (
        <section id="fees" className="mx-auto max-w-7xl px-6 py-12">
            <header className="mb-6 flex items-center justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-gray-600">
                        All values are placeholders in CAD. Confirm current official fees, surcharges, and taxes before remittance.
                    </p>
                </div>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-[#F0F0F0]">
                        <tr>
                            ...
                            <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-gray-600">Official Fee (CAD)</th>
                    ...
                    <tbody className="divide-y divide-gray-100 bg-white">
                        {rows.map(r => (
                            <tr key={r.year}>
                                ...
                                <td className="px-4 py-3 text-gray-700">{r.official ? cad(r.official) : "—"}</td>
                                <td className="px-4 py-3 text-gray-700">{r.service ? cad(r.service) : "—"}</td>
                                <td className="px-4 py-3 font-semibold text-gray-900">{r.total ? cad(r.total) : "—"}</td>
                                <td className="px-4 py-3 text-gray-700">{r.lateSurcharge ? cad(r.lateSurcharge) : "—"}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
            ...
            <p className="mt-3 text-xs text-gray-600">
                * Our team will confirm applicable grace periods and surcharges with CIPO before payment.
            </p>
        </section>
    );
}
...
function HowItWorks() {
    const steps = [
        {
            title: "Share details",
            text: "Provide CA application/grant number and owner details. We run a docketing check and verify due dates.",
        },
        {
    ...
    return (
        <section className="bg-[#F0F0F0] py-12">
            <div className="mx-auto max-w-7xl px-6">
                <h2 className="text-2xl md:text-3xl font-bold text-[#4D1475]">How KA Global IP handles CA renewals</h2>
            ...
            <div className="rounded-2xl bg-white shadow-sm ring-1 ring-gray-200 p-6 md:p-8 grid gap-6 md:grid-cols-12">
                <div className="md:col-span-9">
                    ...
                    <p className="mt-2 text-gray-700 text-sm md:text-base">
                        Renewals affect portfolio value. We map CA renewals to your global strategy—pruning low-value assets, extending core
        ...
        <section className="mx-auto max-w-7xl px-6 py-10">
            <div className="grid gap-6 md:grid-cols-12">
                <div className="md:col-span-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-[#4D1475]">Deadlines & practical notes (CA)</h2>
                    <div className="mt-4 space-y-3 text-sm text-gray-800">
                        <p>• Canadian patent renewals require regular maintenance fees—timing and amounts depend on status and timing. Confirm specifics for your case.</p>
                        <p>• A grace period may be available for missed deadlines with surcharges. Conditions vary; we’ll verify before any payment.</p>
                        <p>• Keep ownership and service address current to avoid missed notices. We can handle recordals ahead of renewals.</p>
                        <p>• For portfolios, consider bundling CA renewals with US/EU/APAC for consolidated billing and better cost control.</p>
                    </div>
                </div>
                <div className="md:col-span-4">
                    <div className="rounded-2xl border border-gray-200 bg-[#F0F0F0] p-5">
                        ...
                        <ul className="mt-3 space-y-2 text-sm text-gray-800">
                            <li>• CA application or patent number</li>
...
function CountryNav() {
    const countries = [
        ...
        // current page is Canada, so we don't list Canada here
    ];
    return (
...
function FAQ() {
    const faqs = [
        {
            q: "When do renewal fees start for Canadian patents?",
            a: "Maintenance obligations apply on a set schedule starting from annuity year 2 due one year after the international filing date. We confirm your exact timing with CIPO and reflect it in your quote.",
        },
        {
            q: "Is there a grace period if we miss a due date?",
            a: "A grace window with surcharges may be available depending on timing and case specifics.",
        },
        {
            q: "Do you manage large portfolios with Canada included?",
        ...
        },
        {
            ...
            a: "Yes. We update ownership or address of service to reduce the risk of missed notices and compliance issues.",
        },
    ];
    return (
        <section className="bg-[#F0F0F0] py-12">
        ...
        <section id="quote" className="relative isolate">
            ...
            <div className="mx-auto max-w-7xl px-6 py-14 text-white">
                <div className="grid items-center gap-6 md:grid-cols-12">
                    <div className="md:col-span-8">
                        <h2 className="text-2xl md:text-3xl font-extrabold">Need a confirmed CA quote today?</h2>
                        <p className="mt-2 text-white/90">
                            Send the CA application/grant number and desired action. We’ll verify deadlines, confirm official fees, and reply with a final quote.
                        </p>
                    </div>
                    <div className="md:col-span-4 md:text-right">
                        <a
                            href="mailto:support@kaglobalip.com?subject=Canada%20Renewal%20Quote"
    ...
    return (
        <section className="mx-auto max-w-7xl px-6 py-8 text-xs text-gray-600">
            <p>
                ...
                fees and rules change. KA Global IP will verify all details with CIPO before filing. Proceed only on the basis
...
function StickyHelpCard() {
    return (
        <div className="sticky top-6 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <p className="mt-2 text-sm text-gray-700">Share your CA patent number and we’ll confirm the actual due date and fees.</p>
            <a
                href="mailto:support@kaglobalip.com?subject=Help%20with%20CA%20Renewal"
...
export default function CanadaRenewalFeesPage() {
    return (
        <>
            <Head>
                <title>Canada Patent Renewal Fees (2025 Guide) | KA Global IP</title>
                <meta
                    name="description"
                    content="Indicative renewal fees, timelines and managed services for Canadian patents. Attorney-led, ISO-certified renewals across 100+ jurisdictions."
                />
                <script
                    ...
                    dangerouslySetInnerHTML={{
                        __html: JSON.stringify({
                            ...
                            "@type": "WebPage",
                            name: "Canada Patent Renewal Fees (2025 Guide)",
                            description: "Indicative renewal fees, deadlines and managed services for CA patents.",
