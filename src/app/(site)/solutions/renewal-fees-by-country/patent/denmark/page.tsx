...
/**
 * KA Global IP – Patent Renewal Fees by Country: Denmark
 * ------------------------------------------------------
 * Path:
 * /app/solutions/renewal-fees-by-country/denmark/page.tsx
 *
 * Brand colors:
 *  - Primary: #7F2B38
 *  - Accent:  #4D1475
 ...
 *
 * Notes:
 *  - Fee numbers below are placeholders in DKK. Replace with live data.
...
const SAMPLE_FEES = Array.from({ length: 20 }, (_, i) => {
    const year = i + 1;
    // Denmark typically uses annual renewals through the term.
    // Placeholder logic only — swap with real values from your backend.
    const official = 80 + year * 25;
    const service = 65;
    const lateSurcharge = Math.round(official * 0.2);
                ...
                <div className="grid items-center gap-8 md:grid-cols-12">
                    <div className="md:col-span-7">
                        <h1 className="text-3xl md:text-5xl font-extrabold leading-tight">
                            Denmark — Patent Renewal Fees (2025 Guide)
                        </h1>
                        <p className="mt-4 text-base md:text-lg text-white/90">
                            Keep your Danish patents in good standing with transparent fees, reminders, and global
                            coverage. This page outlines typical renewal schedules, cost components, and our managed
                            service options for Denmark.
                        </p>
...
function FeeTable() {
    ...
    const rows = useMemo(() => SAMPLE_FEES.filter(r => (showZeros ? true : r.year >= 1)), [showZeros]);
    ...
    return (
        <section id="fees" className="mx-auto max-w-7xl px-6 py-12">
            <header className="mb-6 flex items-center justify-between">
                <div>
                    ...
                    <p className="mt-1 text-sm text-gray-600">
                        All values are placeholders in DKK. Confirm current official fees, surcharges, and taxes before remittance.
                    </p>
                </div>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-[#F0F0F0]">
                        <tr>
                            ...
                            <th className="px-4 py-3 text-left text-xs font-semibold uppercase tracking-wider text-gray-600">Official Fee (DKK)</th>
            ...
            <p className="mt-3 text-xs text-gray-600">
                * Late surcharge logic varies by timing. Our team will confirm applicable grace periods and surcharges with DKPTO before payment.
            </p>
        </section>
    );
}
...
function HowItWorks() {
    const steps = [
        {
            title: "Share details",
            text: "Provide DK or EP application/grant number and owner details. We run a docketing check and verify due dates.",
        },
        {
    ...
    return (
        <section className="bg-[#F0F0F0] py-12">
            <div className="mx-auto max-w-7xl px-6">
                <h2 className="text-2xl md:text-3xl font-bold text-[#4D1475]">How KA Global IP handles DK renewals</h2>
            ...
            <div className="rounded-2xl bg-white shadow-sm ring-1 ring-gray-200 p-6 md:p-8 grid gap-6 md:grid-cols-12">
                <div className="md:col-span-9">
                    ...
                    <p className="mt-2 text-gray-700 text-sm md:text-base">
                        Renewals affect portfolio value. We map DK renewals to your global strategy—pruning low-value assets, extending core
        ...
        <section className="mx-auto max-w-7xl px-6 py-10">
            <div className="grid gap-6 md:grid-cols-12">
                <div className="md:col-span-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-[#4D1475]">Deadlines & practical notes (DK)</h2>
                    <div className="mt-4 space-y-3 text-sm text-gray-800">
                        <p>• Danish patent renewals follow an annual schedule across the term. We confirm exact due dates for each case.</p>
                        <p>• A grace period may be available with surcharges if a deadline is missed—timing and conditions vary.</p>
                        <p>• For EP validations, annuities are payable in Denmark after validation; confirm national specifics in advance.</p>
                        <p>• Keep ownership and service address current to avoid missed notices. We assist with recordals before renewal.</p>
                        <p>• For portfolios, consider bundling DK renewals with EU/EP states for consolidated billing and better cost control.</p>
                    </div>
                </div>
                <div className="md:col-span-4">
                    <div className="rounded-2xl border border-gray-200 bg-[#F0F0F0] p-5">
                        ...
                        <ul className="mt-3 space-y-2 text-sm text-gray-800">
                            <li>• DK application or patent number</li>
...
function CountryNav() {
    const countries = [
        ...
        // current page is Denmark, so we don't list Denmark here
    ];
    return (
...
function FAQ() {
    const faqs = [
        {
            q: "When do renewal fees start for Danish patents?",
            a: "Renewals are payable annually across the patent term. We confirm your exact schedule with DKPTO.",
        },
        {
            q: "Is there a grace period if we miss a due date?",
            a: "Yes—typically with surcharges and conditions depending on timing and case details. We’ll advise on options immediately.",
        },
        {
            q: "Do you manage EP validations in Denmark?",
            a: "Yes. Once the EP is granted and validated in Denmark, subsequent renewals are payable nationally.",
        },
        {
        ...
        <section id="quote" className="relative isolate">
            ...
            <div className="mx-auto max-w-7xl px-6 py-14 text-white">
                <div className="grid items-center gap-6 md:grid-cols-12">
                    <div className="md:col-span-8">
                        <h2 className="text-2xl md:text-3xl font-extrabold">Need a confirmed DK quote today?</h2>
                        <p className="mt-2 text-white/90">
                            Send the DK or EP application/grant number and desired action. We’ll verify deadlines, confirm official fees, and reply with a final quote.
                        </p>
                    </div>
                    <div className="md:col-span-4 md:text-right">
                        <a
                            href="mailto:support@kaglobalip.com?subject=Denmark%20Renewal%20Quote"
    ...
    return (
        <section className="mx-auto max-w-7xl px-6 py-8 text-xs text-gray-600">
            <p>
                ...
                fees and rules change. KA Global IP will verify all details with the Danish Patent and Trademark Office before filing.
...
function StickyHelpCard() {
    return (
        <div className="sticky top-6 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <p className="mt-2 text-sm text-gray-700">Share your DK or EP patent number and we’ll confirm the actual due date and fees.</p>
            <a
                href="mailto:support@kaglobalip.com?subject=Help%20with%20DK%20Renewal"
...
export default function DenmarkRenewalFeesPage() {
    return (
        <>
            <Head>
                <title>Denmark Patent Renewal Fees (2025 Guide) | KA Global IP</title>
                <meta
                    name="description"
                    content="Indicative renewal fees, timelines and managed services for Danish patents. Attorney-led, ISO-certified renewals across 100+ jurisdictions."
                />
                <script
                    ...
                    dangerouslySetInnerHTML={{
                        __html: JSON.stringify({
                            ...
                            "@type": "WebPage",
                            name: "Denmark Patent Renewal Fees (2025 Guide)",
                            description: "Indicative renewal fees, deadlines and managed services for DK patents.",
