...
/**
 * KA Global IP – Patent Renewal Fees by Country: Finland
 * ------------------------------------------------------
 * Path:
 * /app/solutions/renewal-fees-by-country/finland/page.tsx
 *
 * Brand colors:
 *  - Primary: #7F2B38
 *  - Accent:  #4D1475
...
const eur = (n: number) =>
    new Intl.NumberFormat("en-FI", { style: "currency", currency: "EUR" }).format(n);

// ---------- Sample placeholder fee data ----------
const SAMPLE_FEES = Array.from({ length: 20 }, (_, i) => {
    const year = i + 1;
    // Finland: show fees from Year 3 onward (illustrative placeholders)
    const official = year < 3 ? 0 : 90 + year * 22;
                ...
                <div className="grid items-center gap-8 md:grid-cols-12">
                    <div className="md:col-span-7">
                        <h1 className="text-3xl md:text-5xl font-extrabold leading-tight">
                            Finland — Patent Renewal Fees (2025 Guide)
                        </h1>
                        <p className="mt-4 text-base md:text-lg text-white/90">
                            Keep your Finnish patents in good standing with transparent fees, reminders, and global
                            coverage. This page outlines typical renewal schedules, cost components, and our managed
                            service options for Finland.
                        </p>
    ...
    return (
        <section id="fees" className="mx-auto max-w-7xl px-6 py-12">
            ...
            <p className="mt-3 text-xs text-gray-600">
                * Our team will confirm applicable grace periods and surcharges with PRH before payment.
            </p>
        </section>
    );
}
...
function HowItWorks() {
    const steps = [
        {
            title: "Share details",
            text: "Provide FI or EP application/grant number and owner details. We run a docketing check and verify due dates.",
        },
        {
    ...
    return (
        <section className="bg-[#F0F0F0] py-12">
            <div className="mx-auto max-w-7xl px-6">
                <h2 className="text-2xl md:text-3xl font-bold text-[#4D1475]">How KA Global IP handles FI renewals</h2>
            ...
            <div className="rounded-2xl bg-white shadow-sm ring-1 ring-gray-200 p-6 md:p-8 grid gap-6 md:grid-cols-12">
                <div className="md:col-span-9">
                    ...
                    <p className="mt-2 text-gray-700 text-sm md:text-base">
                        Renewals affect portfolio value. We map FI renewals to your global strategy—pruning low-value assets, extending core
        ...
        <section className="mx-auto max-w-7xl px-6 py-10">
            <div className="grid gap-6 md:grid-cols-12">
                <div className="md:col-span-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-[#4D1475]">Deadlines & practical notes (FI)</h2>
                    <div className="mt-4 space-y-3 text-sm text-gray-800">
                        <p>• Direct filings into Finland have patent renewals typically due annually from the <strong>3rd year</strong> onward; we confirm exact dates per case.</p>
                        <p>• A grace period may be available with surcharges if a deadline is missed—timing and conditions vary by circumstance.</p>
                        <p>• For EP validations in Finland, annuities are payable nationally after validation; confirm specifics in advance.</p>
                        <p>• Keep ownership and service address current to avoid missed notices. We can assist with recordals ahead of renewal.</p>
                        <p>• Portfolio tip: consider bundling FI renewals with other Nordics/EU states for consolidated billing and cost control.</p>
                    </div>
                </div>
                <div className="md:col-span-4">
                    <div className="rounded-2xl border border-gray-200 bg-[#F0F0F0] p-5">
                        ...
                        <ul className="mt-3 space-y-2 text-sm text-gray-800">
                            <li>• FI or EP application or patent number</li>
...
function CountryNav() {
    const countries = [
        ...
        // current page is Finland, so we don't list Finland here
    ];
    return (
...
function FAQ() {
    const faqs = [
        {
            q: "When do renewal fees start for Finnish patents?",
            a: "Typically from the 3rd year for direct filings in Finland, then annually. We confirm your exact schedule with PRH.",
        },
        {
        ...
        {
            q: "Do you manage EP validations in Finland?",
            a: "Yes. Once EP is granted and validated in Finland, subsequent renewals are payable nationally.",
        },
        {
        ...
        <section id="quote" className="relative isolate">
            ...
            <div className="mx-auto max-w-7xl px-6 py-14 text-white">
                <div className="grid items-center gap-6 md:grid-cols-12">
                    <div className="md:col-span-8">
                        <h2 className="text-2xl md:text-3xl font-extrabold">Need a confirmed FI quote today?</h2>
                        <p className="mt-2 text-white/90">
                            Send the FI or EP application/grant number and desired action. We’ll verify deadlines, confirm official fees, and reply with a final quote.
                        </p>
                    </div>
                    <div className="md:col-span-4 md:text-right">
                        <a
                            href="mailto:support@kaglobalip.com?subject=Finland%20Renewal%20Quote"
    ...
    return (
        <section className="mx-auto max-w-7xl px-6 py-8 text-xs text-gray-600">
            <p>
                ...
                fees and rules change. KA Global IP will verify all details with the Finnish Patent and Registration Office before filing.
...
function StickyHelpCard() {
    return (
        <div className="sticky top-6 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <p className="mt-2 text-sm text-gray-700">Share your FI patent number and we’ll confirm the actual due date and fees.</p>
            <a
                href="mailto:support@kaglobalip.com?subject=Help%20with%20FI%20Renewal"
...
export default function FinlandRenewalFeesPage() {
    return (
        <>
            <Head>
                <title>Finland Patent Renewal Fees (2025 Guide) | KA Global IP</title>
                <meta
                    name="description"
                    content="Indicative renewal fees, timelines and managed services for Finnish patents. Attorney-led, ISO-certified renewals across 100+ jurisdictions."
                />
                <script
                    ...
                    dangerouslySetInnerHTML={{
                        __html: JSON.stringify({
                            ...
                            "@type": "WebPage",
                            name: "Finland Patent Renewal Fees (2025 Guide)",
                            description: "Indicative renewal fees, deadlines and managed services for FI patents.",
