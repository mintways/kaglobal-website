...
/**
 * KA Global IP – Trademark Renewal Fees by Country: India
 * -------------------------------------------------------
 * Path:
 * /app/(site)/solutions/trademark-renewal-fees-by-country/india/page.tsx
 *
 * Brand colors:
 *  - Primary: #7F2B38
 *  - Accent:  #4D1475
 ...
 *
 * Notes:
 *  - Indian trademark renewals are every 10 years, priced per class.
 *  - Fee figures below are placeholders in INR — replace with your live data.
...
/**
 * IN trade mark renewals are by class: base fee + per extra class.
 * "Window" shows typical timing language for UX; confirm dates case-by-case.
 */
const PLACEHOLDER_FEES = [
    {
        term: "10-year Renewal (on-time)",
        officialBase: 9000, // placeholder
        officialPerExtraClass: 9000, // placeholder
        kaServicePerClass: 2500, // placeholder
        lateSurchargePerClass: 0,
        window: "12 months before expiry until the expiry date",
    },
    {
        ...
        officialPerExtraClass: 9000, // placeholder
        kaServicePerClass: 2500, // placeholder
        lateSurchargePerClass: 2000, // placeholder per class
                ...
                <div className="grid items-center gap-8 md:grid-cols-12">
                    <div className="md:col-span-7">
                        <h1 className="text-3xl md:text-5xl font-extrabold leading-tight">
                            India — Trademark Renewal Fees (2025 Guide)
                        </h1>
                        <p className="mt-4 text-base md:text-lg text-white/90">
                            Renew your Indian trade marks on time—transparent per-class fees, proactive reminders,
                            and attorney-led QA. This page outlines renewal timing, cost components, and our managed
                            service options for India.
                        </p>
        ...
        <section className="bg-[#F0F0F0] py-8 md:py-10">
            <div className="mx-auto max-w-7xl px-6">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
                    ...
                    <FactCard
                        label="Office"
                        value="Office of the CGPDTM (IP India)"
    ...
    return (
        <section id="fees" className="mx-auto max-w-7xl px-6 py-12">
            <header className="mb-6 flex items-center justify-between flex-wrap gap-4">
                <div>
                    ...
                    <p className="mt-1 text-sm text-gray-600">
                        Values below are <span className="font-semibold">placeholders</span> in INR. Indian trade mark renewals are priced per class.
                        Confirm current official fees, GST, and surcharges before remittance.
                    </p>
                </div>
                <div className="flex items-center gap-3 text-sm">
                    <label className="flex items-center gap-2">
                        ...
                        <input
                            ...
                            max={45}
                            value={classes}
                            onChange={(e) => setClasses(Math.max(1, Math.min(45, Number(e.target.value))))}
                    ...
                    <tbody className="divide-y divide-gray-100 bg-white">
                        {rows.map((r, i) => (
                            <tr key={i}>
                                ...
                                <td className="px-4 py-3 text-gray-700">{inr(r.service)}</td>
                                <td className="px-4 py-3 text-gray-700">{r.late ? inr(r.late) : "—"}</td>
            ...
            <p className="mt-3 text-xs text-gray-600">
                * Our team confirms applicability and any per-class fees with IP India before payment.
            </p>
        </section>
    );
}
...
function HowItWorks() {
    const steps = [
        {
            title: "Share details",
            text: "Provide IN TM number, proprietor details, and class list. We verify the expiry date, grace window, and any series/devices.",
        },
        {
            title: "Transparent quote",
            text: "You get a consolidated quote per class with official fees, KA service fee, GST (if applicable), and payment options.",
        },
        {
            title: "Attorney review",
            text: "A trade mark attorney checks for non-use exposure, spec gaps, ownership issues, and pending oppositions.",
        },
        {
            title: "Payment & filing",
            text: "On approval, we renew via IP India e-filing, upload receipts, and update your portal audit trail.",
        },
    ];
    return (
        <section className="bg-[#F0F0F0] py-12">
            <div className="mx-auto max-w-7xl px-6">
                <h2 className="text-2xl md:text-3xl font-bold text-[#4D1475]">How KA Global IP handles IN TM renewals</h2>
            ...
            <div className="rounded-2xl bg-white shadow-sm ring-1 ring-gray-200 p-6 md:p-8 grid gap-6 md:grid-cols-12">
                <div className="md:col-span-9">
                    ...
                    <p className="mt-2 text-gray-700 text-sm md:text-base">
                        We align renewals with brand plans: pruning dormant classes, planning extensions, reviewing non-use risk, and
                        syncing with enforcement priorities. Expect commercial guidance, not just receipts.
                    </p>
                    <ul className="mt-3 grid gap-2 md:grid-cols-2 text-sm text-gray-800">
                        ...
                        <li className="flex items-start gap-2"><FileText className="mt-0.5 h-4 w-4 text-[#4D1475]" /> Audit-ready receipts & GST invoices</li>
        ...
        <section className="mx-auto max-w-7xl px-6 py-10">
            <div className="grid gap-6 md:grid-cols-12">
                <div className="md:col-span-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-[#4D1475]">Deadlines & practical notes (IN TM)</h2>
                    <div className="mt-4 space-y-3 text-sm text-gray-800">
                        <p>• Indian trade marks renew every <strong>10 years</strong> from the registration date; each class renews separately.</p>
                        <p>• Renewal window typically opens ~12 months before expiry; a <strong>grace period (up to ~6 months)</strong> may be available with surcharges.</p>
                        <p>• Lapsed marks may be restorable under limited conditions after grace; we’ll advise case-by-case.</p>
                        <p>• Ensure proprietor details and address for service are current to avoid missed notices; we handle recordals before renewal.</p>
                        <p>• Portfolio tip: coordinate IN renewals with other key markets for consolidated billing and unified reminders.</p>
                    </div>
                </div>
                <div className="md:col-span-4">
                    <div className="rounded-2xl border border-gray-200 bg-[#F0F0F0] p-5">
                        ...
                        <ul className="mt-3 space-y-2 text-sm text-gray-800">
                            <li>• IN TM number(s) and class list</li>
                            <li>• Proprietor details & address for service</li>
                            <li>• Instructions (renew all / select classes / evaluate)</li>
                            <li>• Invoicing preferences (entity, GST, currency)</li>
                        </ul>
                    </div>
                </div>
            </div>
...
function FAQ() {
    const faqs = [
        { q: "How often do Indian trade marks renew?", a: "Every 10 years from registration/filing. Each class renews separately." },
        { q: "Is there a grace period after expiry?", a: "Yes—typically up to ~6 months with surcharges. We confirm the exact window for your case." },
        { q: "Can I renew only some classes?", a: "Yes. You can renew selected classes; others can be allowed to lapse." },
        { q: "Do you help with proprietor/address updates before renewal?", a: "Absolutely—recordals help avoid missed notices and reduce risk." },
    ];
    return (
        <section className="bg-[#F0F0F0] py-12">
            <div className="mx-auto max-w-7xl px-6">
        ...
        <section id="quote" className="relative isolate">
            ...
            <div className="mx-auto max-w-7xl px-6 py-14 text-white">
                <div className="grid items-center gap-6 md:grid-cols-12">
                    <div className="md:col-span-8">
                        <h2 className="text-2xl md:text-3xl font-extrabold">Need an IN TM renewal quote today?</h2>
                        <p className="mt-2 text-white/90">
                            Send the IN TM number(s), classes, and desired action. We’ll verify the deadline, confirm official fees, and reply with a final quote.
                        </p>
                    </div>
                    <div className="md:col-span-4 md:text-right">
                        <a
                            href="mailto:support@kaglobalip.com?subject=India%20Trademark%20Renewal%20Quote"
    ...
    return (
        <section className="mx-auto max-w-7xl px-6 py-8 text-xs text-gray-600">
            <p>
                ...
                fees, and rules change. KA Global IP will verify all details with IP India before filing. Proceed only on the
                basis of our final written quote.
            </p>
        </section>
    );
}
    ...
    return (
        <div className="sticky top-6 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <p className="mt-2 text-sm text-gray-700">
                Share your IN TM number(s) and classes; we’ll confirm the renewal window and fees.
            </p>
            <a
                href="mailto:support@kaglobalip.com?subject=Help%20with%20IN%20TM%20Renewal"
...
export default function IndiaTrademarkRenewalFeesPage() {
    return (
        <>
            <Head>
                <title>India Trademark Renewal Fees (2025 Guide) | KA Global IP</title>
                <meta
                    name="description"
                    content="Indicative trademark renewal fees, timing, and managed services for India. Attorney-led, ISO-certified renewals across 100+ jurisdictions."
                />
                <script
                    ...
                    dangerouslySetInnerHTML={{
                        __html: JSON.stringify({
                            ...
                            "@type": "WebPage",
                            name: "India Trademark Renewal Fees (2025 Guide)",
                            description:
                                "Per-class Indian trade mark renewal timelines and indicative fees. Consolidated quotes and attorney oversight from KA Global IP.",
