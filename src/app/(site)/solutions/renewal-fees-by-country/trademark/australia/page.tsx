...
/**
 * KA Global IP – Trademark Renewal Fees by Country: Australia
 * -----------------------------------------------------------
 * Path:
 * /app/(site)/solutions/trademark-renewal-fees-by-country/australia/page.tsx
 *
 * Brand colors:
 *  - Primary: #7F2B38
 *  - Accent:  #4D1475
 ...
 *
 * Notes:
 *  - Trademark renewals in AU are every 10 years, by class.
 *  - Fee figures below are placeholders in AUD — replace with your live data.
...
/**
 * AU trade mark renewals are by class: base fee + per extra class.
 * "Window" shows typical timing language for UX; confirm dates case-by-case.
 */
const PLACEHOLDER_FEES = [
    {
        term: "10-year Renewal (on-time)",
        officialBase: 350, // placeholder
        officialPerExtraClass: 350, // placeholder
                ...
                <div className="grid items-center gap-8 md:grid-cols-12">
                    <div className="md:col-span-7">
                        <h1 className="text-3xl md:text-5xl font-extrabold leading-tight">
                            Australia — Trademark Renewals (2025 Guide)
                        </h1>
                        <p className="mt-4 text-base md:text-lg text-white/90">
                            Stay compliant with Australian trademark renewal deadlines through a secure, attorney-led
                            process. Explore renewal timelines, fee structure, and how KA Global IP ensures seamless
                            renewals with proactive monitoring and expert oversight.
                        </p>
                        ...
                        <div className="rounded-2xl bg-white/10 p-5 backdrop-blur">
                            <ul className="space-y-3 text-sm">
                                {/* <li className="flex items-start gap-3">
                                    ...
                                    ISO 9001 & 27001 certified processes for secure renewals
                                </li> */}
                                <li className="flex items-start gap-3">
                                    <ShieldCheck className="mt-0.5 h-5 w-5 text-emerald-300" />
                                    Attorney-verified filings with centralized docketing controls
                                </li>
                                <li className="flex items-start gap-3">
                                    <Globe2 className="mt-0.5 h-5 w-5 text-emerald-300" />
                                    Coverage across 100+ jurisdictions through KA Global IP network
                                </li>
                                <li className="flex items-start gap-3">
                                    <Clock className="mt-0.5 h-5 w-5 text-emerald-300" />
                                    Automated reminders, grace-period tracking, and audit history
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    return (
        <section id="fees" className="mx-auto max-w-7xl px-6 py-12">
            <header className="mb-6 flex items-center justify-between flex-wrap gap-4">
                <div>
                    ...
                    <p className="mt-1 text-sm text-gray-600">
                        Values below are <span className="font-semibold">placeholders</span> in AUD. AU trade mark renewals are by class.
            ...
            <div className="overflow-hidden rounded-2xl border border-gray-200 shadow-sm">
                <table className="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody className="divide-y divide-gray-100 bg-white">
                        {rows.map((r, i) => (
                            <tr key={i} className={selection === i ? "bg-violet-50" : ""}>
                                ...
                                <td className="px-4 py-3 text-gray-700">{aud(r.service)}</td>
                                <td className="px-4 py-3 text-gray-700">{r.late ? aud(r.late) : "—"}</td>
                                <td className="px-4 py-3 font-semibold text-gray-900">{aud(r.total)}</td>
            ...
            {/* <p className="mt-3 text-xs text-gray-600">
                * Late surcharge logic varies by timing. Our team confirms grace applicability and any per-class surcharges with IP Australia before payment.
            </p> */}
        </section>
    );
}
...
function HowItWorks() {
    const steps = [
        {
            title: "Share details",
            text: "Provide AU TM number, owner details, and classes. We verify the expiry date, grace window, and any series or endorsements.",
        },
        {
        ...
        },
        {
            ...
            text: "On approval, we renew with IP Australia, upload receipts, and update your portal audit trail.",
        },
    ];
    return (
        <section className="bg-[#F0F0F0] py-12">
            <div className="mx-auto max-w-7xl px-6">
                <h2 className="text-2xl md:text-3xl font-bold text-[#4D1475]">How KA Global IP handles AU TM renewals</h2>
            ...
            <div className="rounded-2xl bg-white shadow-sm ring-1 ring-gray-200 p-6 md:p-8 grid gap-6 md:grid-cols-12">
                <div className="md:col-span-9">
                    ...
                    <p className="mt-2 text-gray-700 text-sm md:text-base">
                        We align renewals with brand plans: pruning dormant classes, planning extensions, and tracking coexistence or
                        non-use exposure. Expect commercial guidance, not just receipts.
                    </p>
        ...
        <section className="mx-auto max-w-7xl px-6 py-10">
            <div className="grid gap-6 md:grid-cols-12">
                <div className="md:col-span-8">
                    <h2 className="text-2xl md:text-3xl font-bold text-[#4D1475]">Deadlines & practical notes (AU TM)</h2>
                    <div className="mt-4 space-y-3 text-sm text-gray-800">
                        <p>• AU trade marks renew every <strong>10 years</strong> from the filing date; multiple classes renew separately.</p>
                        ...
                        <p>• Maintain accurate owner details and address for service to avoid missed notices; we can handle recordals prior to renewal.</p>
                        <p>• Non-use exposure can arise if a mark is unused for extended periods; we can assess risk and evidence before renewal spend.</p>
                        <p>• Portfolio tip: coordinate AU renewals with other key markets for consolidated billing and unified reminders.</p>
                    </div>
                </div>
                <div className="md:col-span-4">
                    <div className="rounded-2xl border border-gray-200 bg-[#F0F0F0] p-5">
                        ...
                        <ul className="mt-3 space-y-2 text-sm text-gray-800">
                            <li>• AU TM number(s) and class list</li>
...
function FAQ() {
    const faqs = [
        { q: "How often do AU trade marks renew?", a: "Every 10 years from filing. Each class renews separately." },
        ...
        <section id="quote" className="relative isolate">
            ...
            <div className="mx-auto max-w-7xl px-6 py-14 text-white">
                <div className="grid items-center gap-6 md:grid-cols-12">
                    <div className="md:col-span-8">
                        <h2 className="text-2xl md:text-3xl font-extrabold">Need an AU TM renewal quote today?</h2>
                        <p className="mt-2 text-white/90">
                            Send the AU TM number(s), classes, and desired action. We’ll verify the deadline, confirm official fees, and reply with a final quote.
                        </p>
                    </div>
                    <div className="md:col-span-4 md:text-right">
                        <a
                            href="mailto:support@kaglobalip.com?subject=Australia%20Trademark%20Renewal%20Quote"
    ...
    return (
        <section className="mx-auto max-w-7xl px-6 py-8 text-xs text-gray-600">
            <p>
                ...
                fees, and rules change. KA Global IP will verify all details with IP Australia before filing. Proceed only on
    ...
    return (
        <div className="sticky top-6 rounded-2xl border border-gray-200 bg-white p-5 shadow-sm">
            ...
            <p className="mt-2 text-sm text-gray-700">
                Share your AU TM number(s) and classes; we’ll confirm the renewal window and fees.
            </p>
            <a
                href="mailto:support@kaglobalip.com?subject=Help%20with%20AU%20TM%20Renewal"
...
export default function AustraliaTrademarkRenewalFeesPage() {
    return (
        <>
            <Head>
                <title>Australia Trademark Renewal Fees (2025 Guide) | KA Global IP</title>
                <meta
                    name="description"
                    content="Indicative trademark renewal fees, timing, and managed services for Australia. Attorney-led, ISO-certified renewals across 100+ jurisdictions."
                />
                <script
                    ...
                    dangerouslySetInnerHTML={{
                        __html: JSON.stringify({
                            ...
                            "@type": "WebPage",
                            name: "Australia Trademark Renewal Fees (2025 Guide)",
                            description:
                                "Per-class AU trade mark renewal timelines and indicative fees. Consolidated quotes and attorney oversight from KA Global IP.",
