        ...
        <Section className="bg-white font-ptsans">
            <div className="mx-auto max-w-7xl px-6 py-12 sm:py-14 md:py-16">
                ...
                <div className="mx-auto max-w-3xl text-center">
                    <h2 className="font-playfair text-2xl sm:text-3xl md:text-4xl bg-gradient-to-r from-[#7F2B38] to-[#4D1475] bg-clip-text text-transparent">
                        A Network That Works for You
                    </h2>
                    <p className="mt-3 text-base text-[#444] md:text-lg font-ptsans">
                        Our strength lies in a carefully curated global partner network—comprising expert IP attorneys,
                        patent agents, technical specialists, valuers, and strategists—each bringing invaluable local nuance
                        fortified by a worldwide perspective.
                    </p>
                </div>
                ...
                <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-2 md:grid-cols-3">
                    {bullets.map(({ icon: Icon, title, text }, i) => (
                        ...
                        >
                            ...
                            <p className="mt-3 text-sm text-[#555] font-ptsans">
                                {text}
                            </p>
                        </div>
                    ))}
