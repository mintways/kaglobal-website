...
export default function CommitmentCTA() {
    return (
        <Section className="relative isolate overflow-hidden bg-white text-ka-ink font-ptsans">
            ...
            {/* Content */}
            <div className="relative mx-auto max-w-7xl px-6 py-14 text-center sm:py-16 md:py-20">
                {/* Heading */}
                <h2 className="font-playfair text-2xl leading-tight sm:text-3xl md:text-4xl">
                    Shaping Tomorrow’s{" "}
                ...
                <div className="mt-8 flex flex-wrap justify-center gap-4">
                    <Link
                        ...
                        className="group inline-flex items-center gap-2 rounded-2xl bg-[#7F2B38] px-6 py-3 text-sm font-semibold text-white shadow-sm transition hover:-translate-y-0.5 hover:bg-[#65285F] font-ptsans"
                    >
                    ...
                    <Link
                        href="/contact"
                        className="group inline-flex items-center gap-2 rounded-2xl border border-[#4D1475]/40 px-6 py-3 text-sm font-semibold text-[#4D1475] transition hover:-translate-y-0.5 hover:bg-[#4D1475]/10 font-ptsans"
                    >
                        Speak to an Expert
                        <ArrowRight className="h-4 w-4 transition-transform group-hover:translate-x-1" />
                    </Link>
