...
const CARDS = [
    { t: "Patents", d: "Drafting, filing, prosecution, oppositions, analytics & landscapes." },
    { t: "Trademarks", d: "Clearance, filing, prosecution, enforcement & brand strategy." },
    { t: "Designs", d: "Aesthetic protection across jurisdictions with fast turnarounds." },
    { t: "Litigation & Enforcement", d: "Dispute strategy, cross-border coordination, and defense." },
    { t: "Portfolio Management", d: "Docketing, annuities, renewals, and global counsel orchestration." },
    { t: "Monetisation & Licensing", d: "Licensing, valuation, technology transfer & deal support." },
    { t: "Research & Analytics", d: "Prior art, FTO, invalidation, white-space and competitive intel." },
    { t: "Strategic Advisory", d: "Commercial contracts, governance, and regulatory compliance." },
    { t: "Data & Tools", d: "Custom scrapers, dashboards, and workflow automations." },
];

const slug = (s: string) =>
    "/services#" + s.toLowerCase().replace(/[^a-z0-9]+/g, "-").replace(/(^-|-$)/g, "");
                ...
                <div className="grid gap-4 sm:gap-5 md:grid-cols-2 lg:grid-cols-3">
                    {CARDS.map((c) => (
                        <a
                            key={c.t}
                            href={slug(c.t)}
                            className="group relative overflow-hidden rounded-3xl border border-black/10 bg-white/80 p-6 shadow-sm backdrop-blur transition hover:-translate-y-0.5 hover:shadow-md focus:outline-none focus:ring-2 focus:ring-[#7F2B38]/40"
                        >
                            ...
                            <div className="relative z-10 flex items-start gap-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-euclid font-semibold text-gray-900">{c.t}</h3>
                                    <p className="mt-1.5 text-sm text-[#1F2A44]/90">{c.d}</p>
                                </div>
                            </div>
