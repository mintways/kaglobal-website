            ...
            <div className="relative mx-auto max-w-7xl px-6 py-16">
                <div className="grid items-center gap-10 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        {/* region bullets -> upgraded to icon list */}
                            ...
                            {[
                                ...
                                <li key={item} className="flex items-start gap-3 text-gray-800">
                                    <span className="mt-1 inline-flex h-5 w-5 flex-none items-center justify-center rounded-md bg-[#7F2B38]/10">
                                        <svg
                                            viewBox="0 0 20 20"
                                            className="h-3.5 w-3.5 text-[#7F2B38]"
                                            fill="currentColor"
                                        >
                                            <path
                                                fillRule="evenodd"
                        ...
                        <div className="mt-6 flex flex-wrap gap-2">
                            {["US", "EU/UK", "India", "China", "Japan", "Korea", "ASEAN", "MENA", "Africa", "LatAm"].map(
                                (chip) => (
                                    <span
                                        key={chip}
                                        className="rounded-full border border-black/10 bg-white px-3 py-1 text-xs text-gray-700 shadow-sm font-ptsans"
                                    >
                                        {chip}
                                    </span>
                                )
                        ...
                        <div className="mt-8 flex gap-3">
                            <a
                                href="/contact"
                                className="rounded-2xl bg-[#7F2B38] px-5 py-3 text-white shadow-sm transition hover:opacity-90"
                            >
                                Coordinate a Filing
                            </a>
                            <a
                        ...
                        <div className="relative overflow-hidden rounded-3xl border border-[#4D1475]/15 bg-gradient-to-br from-[#F8F1FF] via-white to-[#F8F1FF] p-6 shadow-sm">
                            ...
                            <div className="relative aspect-[4/3] w-full rounded-2xl bg-white">
                                ...
                                {[
                                    ...
                                    { x: "72%", y: "50%" }, // India
                                    { x: "78%", y: "42%" }, // China
                                    { x: "83%", y: "38%" }, // Japan/Korea region-ish
                                    { x: "55%", y: "65%" }, // Africa
                                    { x: "45%", y: "75%" }, // LatAm
                                ].map((n, i) => (
                                    <span
