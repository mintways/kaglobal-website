        ...
        >
            ...
            <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-6 py-12 sm:px-8 md:grid-cols-12 md:gap-12 md:py-16">
                ...
                <div className="md:col-span-7">
                    ...
                    {/* heading */}
                    <h1 className="font-playfair text-[clamp(1.9rem,4vw,3.1rem)] leading-tight text-ka-ink">
                        <span
...
function DesignIcon({ className = "" }: { className?: string }) {
    return (
        <svg className={className} viewBox="0 0 480 480" fill="none" strokeLinecap="round" strokeLinejoin="round">
            <defs>
