...
export default function CTASection({
    ...
    return (
        <section className="mx-auto max-w-7xl px-6 py-20">
            <div className="rounded-[3rem] bg-gradient-to-b from-[#4A0D4D] to-[#7C1E2F] px-6 py-16 text-center md:py-20 lg:px-20">
                <h2 className="font-playfair text-white text-3xl font-bold leading-tight md:text-4xl lg:text-5xl">
                    {heading}
                </h2>

                <p className="font-ptsans text-white mx-auto mt-6 max-w-2xl text-lg leading-7">
                    {text}
                </p>
