                    ...
                    <div>
                        ...
                        >
                            <span className="bg-gradient-to-r from-[#7F2B38] via-[#581845] to-[#4B2E83] bg-clip-text text-transparent">
                                Trademark Renewal Fees by Country
                            </span>
                        </motion.h1>
                        ...
                        >
                            A practical view of renewal (annuity) costs across major jurisdictions—curated by KA Global IP’s portfolio team.
                            Use filters to compare timelines, grace periods, and late fees. For live quotes and consolidated invoicing, talk to us.
                        </motion.p>
