        ...
        <div className="grid items-center gap-10 py-16 md:grid-cols-2 md:py-24">
          <div>
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-gray-200 bg-white/80 px-3 py-1 text-xs font-medium text-gray-700 shadow-sm backdrop-blur font-ptsans">
              <span className="inline-block h-2 w-2 rounded-full bg-rose-500" /> Research
            </div>
            ...
            >
              Transform raw data into decisive action: comprehensive patentability assessments, Freedom-to-Operate (FTO) analysis, 
              competitive intelligence mapping, and invalidity searches—all delivered as decision-ready insights.
            </motion.p>
            ...
            >
              <Pill>Patentability</Pill>
              <Pill>Freedom-to-Operate</Pill>
              <Pill>Competitive Intelligence</Pill>
              <Pill>Invalidity</Pill>
            </motion.div>
          </div>
          ...
          >
            <motion.div animate={{ y: [0, -8, 0] }} transition={{ repeat: Infinity, duration: 3, ease: "easeInOut" }}>
              <Search className="h-54 w-54 text-[#4B2E83]" strokeWidth={1.5} />
            </motion.div>
          </motion.div>
        </div>
      </Container>
