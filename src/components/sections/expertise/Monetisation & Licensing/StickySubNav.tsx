...
const TABS = [
    { id: "differentiators", label: "Partner With Us" },
    { id: "monetisation-services", label: "Services" }, // matches the monetisation services section id
    { id: "why", label: "Monetise" }, 
    { id: "cta", label: "Get a Licensing Proposal" },
];
