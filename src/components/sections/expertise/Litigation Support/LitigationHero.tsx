...
export default function LitigationHero() {
    return (
        <section
                ...
                <div className="grid items-center gap-10 py-16 md:grid-cols-2 md:py-24">
                    ...
                    <div>
                        ...
                        <motion.h1
                            ...
                            className="font-playfair text-4xl font-bold tracking-tight md:text-6xl leading-tight"
                        >
                            <span className="bg-gradient-to-r from-[#7F2B38] via-[#581845] to-[#4B2E83] bg-clip-text text-transparent">
                                Defending Your Rights Globally
                            </span>
                        </motion.h1>
                        ...
                        <motion.p
                            ...
                            className="font-ptsans mt-5 max-w-xl text-lg leading-relaxed text-[#2B3852]/90"
                        >
                            Strategic intellectual property dispute resolution and enforcement services—meticulously 
                            designed to protect your innovations, brands, and trade secrets across all relevant jurisdictions.
                        </motion.p>
                        ...
                        >
                            <Pill>Patent Litigation</Pill>
                            <Pill>Trademark Enforcement</Pill>
                            <Pill>Trade Secrets</Pill>
                            <Pill>Cross-Border Strategy</Pill>
                        </motion.div>
                    </div>
                    ...
                    >
                        ...
                        >
                            <Gavel className="h-[340px] w-[340px] text-[#4B2E83]" strokeWidth={1.5} />
                        </motion.div>
                    </motion.div>
                </div>
            </Container>
