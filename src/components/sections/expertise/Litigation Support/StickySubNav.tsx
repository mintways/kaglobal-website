  ...
  return (
    <div className="sticky top-0 z-30 border-b border-gray-200 bg-white/80 backdrop-blur">
      ...
      <div className="mx-auto w-full max-w-6xl px-6">
        <nav className="flex gap-2 overflow-x-auto py-3" aria-label="Secondary">
          {TABS.map((t) => {
            ...
            return (
              <a
                ...
                className={[
                  "whitespace-nowrap rounded-full px-3 py-1.5 text-sm font-ptsans transition-colors",
                  "focus:outline-none focus-visible:ring-2 focus-visible:ring-[#7F2B38]/30 focus-visible:ring-offset-2 focus-visible:ring-offset-white",
                  isActive
